...
const std::string kLibraryPath = "/home/cwz/Documents/HectoDrone/ground-station/grid-service/build/gtsp_instances-prefix/src/gtsp_instances";
...
TEST(GkMa, LoadFromFile) {
  ...
  // Instances directory.
  std::string instances_path = kLibraryPath;
